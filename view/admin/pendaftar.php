...
<head>
  ...
  <title>Pendaftar Calon Siswa Admin - Sekolah Digital Talent</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Pendaftar Calon Siswa</h1>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Daftar Pendaftar Calon Siswa yang Perlu Disetujui</h6>
            </div>
            <div class="card-body">
